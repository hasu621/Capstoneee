...
import { NavLink, Outlet, useNavigate } from 'react-router-dom'; // IDAGDAG ANG useState, useEffect, useNavigate
...
// ===========================================
// 1. Admin Sidebar Component (UPDATED with Verification)
// ===========================================
// Ginawa nating prop ang user para magamit ang data
const AdminSidebar = ({ user }) => { 
    // Nav items updated to include the new Verification route
    const navItems = [
        { name: 'Dashboard', icon: 'fas fa-th-large', to: '/admin-dashboard' },
        { name: 'Application', icon: 'fas fa-file-alt', to: '/admin-application' }, 
        // Verification link
        { name: 'Verification', icon: 'fas fa-user-check', to: '/admin-verification' }, 
